...
export type ConfigKeyMap = {
  ...
  'system.weixinCompletionDeliveryEnabled': boolean | undefined;
  'system.weixinIdleTimeoutMinutes': number | undefined;
  'system.weixinIdlePolicy': 'auto' | 'ask' | 'disabled' | undefined;
  'system.keepAwake': boolean | undefined;
  'system.autoPreviewOfficeFiles': boolean | undefined;
  'conversation.forkMode': 'fork_only' | 'fork_and_edit' | undefined;
