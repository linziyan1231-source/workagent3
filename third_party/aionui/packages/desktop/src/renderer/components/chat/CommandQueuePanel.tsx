...
import { CornerDownRight, Delete, DirectionAdjustment, Drag, MoreOne } from '@icon-park/react';
...
type CommandQueuePanelProps = {
  ...
  onSteer?: (item: ConversationCommandQueueItem) => void;
  steeringCommandId?: string | null;
      ...
      <div className='flex items-center gap-0.5 shrink-0'>
        {onSteer
          ? renderQueueActionIconButton({
              ariaLabel: t('conversation.commandQueue.steer', { defaultValue: 'Steer current response' }),
              disabled: steeringCommandId !== null && steeringCommandId !== undefined,
              onClick: () => onSteer(item),
              icon: <DirectionAdjustment theme='outline' size='14' strokeWidth={2.5} />,
            })
          : null}
        {renderQueueActionIconButton({
