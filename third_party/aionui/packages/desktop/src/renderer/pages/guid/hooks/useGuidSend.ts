...
export const useGuidSend = (deps: GuidSendDeps): GuidSendResult => {
  ...
  const handleSend = useCallback(async () => {
    ...
    const assistantOverrides = {
      ...
      thought_level: selectedAcpThoughtLevel || undefined,
    ...
    const pendingConfigOptions =
      currentAgentThoughtLevel && selectedAcpThoughtLevel
        ? { [currentAgentThoughtLevel.id]: selectedAcpThoughtLevel }
        : undefined;
    ...
    try {
      const conversation = await ipcBridge.conversation.create.invoke({
        ...
        extra: {
          ...
          thought_level: selectedAcpThoughtLevel || undefined,
          pending_config_options: pendingConfigOptions,
        },
      });
      if (!conversation || !conversation.id) {
