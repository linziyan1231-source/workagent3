...
export const AUTO_PREVIEW_MAX_BYTES = 200 * 1024 * 1024;

export function canAutoPreviewFileSize(size: number): boolean {
  return Number.isFinite(size) && size >= 0 && size <= AUTO_PREVIEW_MAX_BYTES;
}
