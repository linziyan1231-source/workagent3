...
func (s *Server) HandlerWithWeb(web http.Handler) http.Handler {
	...
	mux.HandleFunc("GET /api/portal/admin/published-apps/settings", s.requireUser(s.requireAdmin(s.adminPublishedAppSettings)))
	mux.HandleFunc("PUT /api/portal/admin/published-apps/settings", s.requireUser(s.requireAdmin(s.adminPublishedAppSettings)))
	mux.HandleFunc("GET /api/portal/admin/published-apps", s.requireUser(s.requireAdmin(s.adminPublishedApps)))
	mux.HandleFunc("POST /api/portal/admin/published-apps/{id}/unpublish", s.requireUser(s.requireAdmin(s.adminUnpublishPublishedApp)))
