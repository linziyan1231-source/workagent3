...
func TestButlerScope(t *testing.T) {
	for _, test := range []struct {
		...
		{"POST", "/v1/session-tools", true},
		{"GET", "/v1/session-tools", false},
		{"POST", "/v1/teams/other/runs", false},
		...
		{"GET", "/v1/app-publishing", true},
		{"POST", "/v1/app-publishing/publish", true},
		{"DELETE", "/v1/app-publishing", false},
		{"POST", "/v1/app-publishing", false},
		{"GET", "/v1/app-publishing/publish", false},
