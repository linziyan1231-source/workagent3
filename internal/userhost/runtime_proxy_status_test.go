...
func TestRuntimeGatewayPreservesCreatedStatus(t *testing.T) {
	...
	handler := newRuntimeGatewayHandlerWithControl(nil, nil, nil, nil, nil, nil, nil, target, "runtime-token", nil, nil, nil)
...
func TestPortalAndRuntimeGatewayPreserveCreatedStatus(t *testing.T) {
	...
	gateway := httptest.NewServer(newRuntimeGatewayHandlerWithControl(nil, nil, nil, nil, nil, nil, nil, harnessURL, "runtime-token", nil, nil, nil))
	defer gateway.Close()
