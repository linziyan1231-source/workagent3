...
import { usageApi, type Budget } from "./usageApi.js";
import { errorMessage } from "../shared/adminErrors.js";
import { modelName, number } from "./usageFormat.js";
import { ActionForm, date } from "../shared/adminUi.js";
export function QuotaEditor({ username }: { username: string }) {
  ...
  const load = async () => {
    setError("");
    try {
      setBudgets((await usageApi.budgets(username)).budgets);
    } catch (e) {
