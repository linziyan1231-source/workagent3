...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@/renderer/hooks/context/AuthContext", replacement: adapter("authContext.tsx") },
      { find: "@renderer/hooks/context/AuthContext", replacement: adapter("authContext.tsx") },
      { find: "@/renderer/hooks/context/FeedbackContext", replacement: adapter("feedbackContext.ts") },
      { find: "@renderer/hooks/context/NavigationHistoryContext", replacement: adapter("NavigationHistoryContext.tsx") },
      { find: "@/renderer/hooks/context/NavigationHistoryContext", replacement: adapter("NavigationHistoryContext.tsx") },
      { find: "@renderer/hooks/system/useDeepLink", replacement: adapter("layoutHooks.tsx") },
      { find: "@renderer/hooks/system/notification/useNotificationClick", replacement: adapter("layoutHooks.tsx") },
      { find: "@renderer/hooks/system/notification/useBrowserNotification", replacement: adapter("layoutHooks.tsx") },
      { find: "@renderer/hooks/file/useDirectorySelection", replacement: adapter("layoutHooks.tsx") },
      { find: "@renderer/hooks/ui/useConversationShortcuts", replacement: adapter("layoutHooks.tsx") },
      { find: "@/renderer/components/layout/PwaPullToRefresh", replacement: adapter("PwaPullToRefresh.tsx") },
      { find: "@/renderer/components/settings/UpdateModal", replacement: adapter("UpdateModal.tsx") },
      { find: "@renderer/pages/conversation/GroupedHistory/ConversationSearchPopover", replacement: adapter("ConversationSearchPopover.tsx") },
      { find: "./SharedInviteNotifications", replacement: adapter("EmptyRendererComponent.tsx") },
      { find: "../WindowControls", replacement: adapter("EmptyRendererComponent.tsx") },
