...
The DSH Web **Settings → Message Channels** page uses the pinned community plugin
...
**Settings → Message Reminders** enables optional task-completion pushes. Choose a
