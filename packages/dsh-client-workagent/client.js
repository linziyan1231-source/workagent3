...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function useResource(endpoint3, select = (value) => value, cache2) {
      const cached = () => cache2?.get(endpoint3);
      ...
      const load = import_react.default.useCallback(
        async (signal, quiet = false) => {
          ...
          try {
            const value = await request(endpoint3, { signal });
            ...
            cache2?.set(endpoint3, next);
            setState(next);
          } catch (error) {
            if (signal?.aborted || generation !== resourceGeneration.current)
              return;
            if ([401, 403, 404].includes(error.status))
              cache2?.remove(endpoint3);
    ...
    function Card({ title, detail, children, ...props }) {
      return (0, import_react3.createElement)(
        ...
        (0, import_react3.createElement)("strong", null, title),
        detail
          ? (0, import_react3.createElement)(
              "div",
              { className: "workagent-muted" },
    ...
    function Section({ title, children }) {
      return (0, import_react3.createElement)(
        ...
        (0, import_react3.createElement)("h2", null, title),
        children,
      );
    }
    ...
    function AcpCredentialsRow({ entry, refresh }) {
      ...
      const [notice, setNotice] = import_react4.default.useState("");
      ...
      return (0, import_react4.createElement)(
        ...
        (0, import_react4.createElement)("strong", null, entry.label),
        ...
        error
          ? (0, import_react4.createElement)("p", { role: "alert" }, error)
          : notice
            ? (0, import_react4.createElement)("p", { role: "status" }, notice)
            : null,
      );
    }
    function AcpCredentials() {
      ...
      return (0, import_react4.createElement)(
        ...
        (0, import_react4.createElement)(Status, { state }),
        ...state.rows.map((entry) =>
          (0, import_react4.createElement)(AcpCredentialsRow, {
            key: entry.id,
            entry,
            refresh,
          }),
    ...
    function createNavigation(React40, onNavigate = () => {}) {
      ...
      const useSearch = () => React40.useSyncExternalStore(subscribe, snapshot);
    ...
    function createAssistantAvatars({
      ...
      const h36 = React40.createElement;
      const choices = [
        "✨",
        "🤖",
        "🦊",
      ...
      function AssistantAvatar2({ preset, size }) {
        ...
        const [failed, setFailed] = React40.useState(null);
        const style = {
        ...
        if (!avatar && (builtinEngine || !preset?.name))
          return h36(EngineMark2, { engine: preset?.engine || "harness" });
      ...
      function SessionAvatar2({ session }) {
        const rows = React40.useSyncExternalStore(subscribe, () => presets);
      ...
      function AvatarPicker2({
        ...
        const [error, setError] = React40.useState("");
        const input = React40.useRef();
        ...
        return h36(
          ...
          error
            ? h36("p", { role: "alert", className: "workagent-error" }, error)
            : null,
        );
      }
      function AvatarField2({ preset, onBusyChange }) {
        const [value, setValue] = React40.useState(preset?.avatar || null);
        return h36(
          "div",
          null,
          h36("div", null, "头像"),
          h36("input", { type: "hidden", name: "avatar", value: value || "" }),
          h36(AvatarPicker2, {
    ...
    function Icon({ name, size = 18, className = "" }) {
      return (0, import_react6.createElement)(
        ...
        ...(iconPaths[name] || iconPaths.harness).map((d, index) =>
          (0, import_react6.createElement)("path", { d, key: index }),
        ),
      );
    }
    ...
    function Dialog({
      ...
      const hostRef = import_react8.default.useRef(null);
      const previousFocus = import_react8.default.useRef(
        typeof document === "undefined" ? null : document.activeElement,
      );
      const close = import_react8.default.useRef({ onClose, closeDisabled });
      close.current = { onClose, closeDisabled };
      const titleId = import_react8.default.useId();
      ...
      return (0, import_react9.createElement)(
        ...
        (0, import_react9.createElement)(
          ...
          (0, import_react9.createElement)(
            ...
            (0, import_react9.createElement)("h2", { id: titleId }, title),
            (0, import_react9.createElement)(
              Button,
              {
              ...
              (0, import_react9.createElement)(Icon, {
                name: "close",
                size: 18,
              }),
            ),
    ...
    function useConfirm() {
      const [request2, setRequest] = import_react8.default.useState(null);
      const pending = import_react8.default.useRef(null);
      import_react8.default.useEffect(() => () => pending.current?.(false), []);
      const finish = import_react8.default.useCallback((value) => {
        pending.current?.(value);
        pending.current = null;
        setRequest(null);
      }, []);
      const confirm = import_react8.default.useCallback(
        (options) =>
          new Promise((resolve) => {
      ...
      const confirmation = request2
        ? (0, import_react9.createElement)(
            ...
            (0, import_react9.createElement)("p", null, request2.description),
            (0, import_react9.createElement)(
              "div",
    ...
    function useAgentOrder(presets) {
      ...
      const [order, setOrder] = import_react10.default.useState(read);
    ...
    function AgentDisplaySettings({ presets }) {
      ...
      const [error, setError] = import_react10.default.useState("");
      ...
      return (0, import_react11.createElement)(
        ...
        (0, import_react11.createElement)("h3", null, "主页 Agent 顺序"),
        ...
        (0, import_react11.createElement)(
          ...
          ...rows.map((preset, index) =>
            (0, import_react11.createElement)(
              ...
              (0, import_react11.createElement)(AssistantAvatar, { preset }),
              (0, import_react11.createElement)(
                "span",
        ...
        error
          ? (0, import_react11.createElement)("p", { role: "alert" }, error)
          : notice
            ? (0, import_react11.createElement)("p", { role: "status" }, notice)
            : null,
      );
    }
    function AgentPicker() {
      ...
      const root = import_react10.default.useRef(null),
        more = import_react10.default.useRef(null);
      import_react10.default.useEffect(() => {
    ...
    function CapabilityPicker({
      ...
      const [ids, setIds] = import_react12.default.useState(selected);
      ...
      return (0, import_react13.createElement)(
        ...
        (0, import_react13.createElement)("legend", null, label),
        (0, import_react13.createElement)("input", {
          type: "hidden",
          name,
          value: ids.join(","),
        }),
        (0, import_react13.createElement)(
          ...
          state.loading
            ? (0, import_react13.createElement)("p", null, "正在加载…")
            : state.error
              ? (0, import_react13.createElement)(
                  "p",
                  { role: "alert" },
    ...
    function PresetsSection() {
      ...
      const endpoint3 = `${apiRoot}/presets`;
      ...
      const [editing, setEditing] = import_react12.default.useState(null);
      const [formVersion, setFormVersion] = import_react12.default.useState(0);
      const [avatarEditing, setAvatarEditing] =
        import_react12.default.useState(null);
      const [avatarBusy, setAvatarBusy] =
        import_react12.default.useState(false);
      const [error, setError] = import_react12.default.useState("");
      const [pendingId, setPendingId] = import_react12.default.useState(null);
      const toggle = async (row, enabled) => {
        setPendingId(row.id);
        await mutatePreset(
          refresh,
          setError,
          `${endpoint3}/${encodeURIComponent(row.id)}`,
          "PATCH",
          { enabled },
        );
        setPendingId(null);
      ...
      const submit = async (event) => {
        ...
        const saved = await mutatePreset(
          ...
          setError,
          editing
            ? `${endpoint3}/${encodeURIComponent(editing.id)}`
            : endpoint3,
          editing ? "PATCH" : "POST",
          body,
        );
      ...
      return (0, import_react13.createElement)(
        Section,
        { title: "助手" },
        (0, import_react13.createElement)(AcpCredentials),
        (0, import_react13.createElement)(AgentDisplaySettings, {
          presets: state.rows,
        }),
        (0, import_react13.createElement)(
          Button,
        ...
        (0, import_react13.createElement)(
          ...
          (0, import_react13.createElement)(AvatarField, {
            preset: editing,
          ...
          (0, import_react13.createElement)(
            Field,
            { label: "引擎" },
            (0, import_react13.createElement)(Select, {
              name: "engine",
              defaultValue:
                editing?.engine === "acp"
              ...
              options: [
                ...
                ...acp.rows
                  .filter(
                    (row) => row.enabled || row.id === editing?.acpCatalogId,
                  )
                  .map((row) => [
                    `acp:${row.id}`,
          ...
          (0, import_react13.createElement)(CapabilityPicker, {
            name: "skillIds",
            label: "技能",
            state: skills,
          ...
          (0, import_react13.createElement)(
            Field,
            { label: "系统提示词" },
            (0, import_react13.createElement)("textarea", {
              name: "systemPrompt",
        ...
        error
          ...
          : null,
        (0, import_react13.createElement)(Status, { state }),
        ...state.rows.map((row) =>
          (0, import_react13.createElement)(
            "article",
            {
            ...
            (0, import_react13.createElement)(
              ...
              (0, import_react13.createElement)(AssistantAvatar, {
                preset: row,
                size: 36,
              }),
              (0, import_react13.createElement)(
            ...
            (0, import_react13.createElement)(Switch, {
            ...
            avatarEditing === row.id
              ? (0, import_react13.createElement)(
                  ...
                  (0, import_react13.createElement)(AvatarPicker, {
                    preset: row,
                    value: row.avatar,
    ...
    function createAutomations({
      ...
      const h36 = React40.createElement;
      const endpoint3 = `${apiRoot2}/automations`;
      const runLabels = {
        pending: "等待",
        waiting: "等待对话空闲",
      ...
      function SkillSuggestion({ row, run, saved }) {
        const [text, setText] = React40.useState(null);
        const [name, setName] = React40.useState(`${row.name}执行流程`);
        const [busy, setBusy] = React40.useState(false);
        const [error, setError] = React40.useState("");
        const [ignored, setIgnored] = React40.useState(false);
        const [installedId, setInstalledId] = React40.useState(null);
        ...
        return h36(
          ...
          text !== null
            ...
            : null,
          error ? h36("p", { role: "alert" }, error) : null,
        );
      }
      function Editor({
        row,
        ...
        const [kind, setKind] = React40.useState(
          row?.schedule.kind || "interval",
        );
        const [mode, setMode] = React40.useState(
          row?.executionMode || "new_conversation",
        );
        const [presetId, setPresetId] = React40.useState(row?.presetId || "");
        const [workspaceId, setWorkspaceId] = React40.useState(
          row?.workspaceId || "",
        );
        const [messageNotificationEnabled, setMessageNotificationEnabled] =
          React40.useState(row?.messageNotificationEnabled === true);
        const [error, setError] = React40.useState("");
        const [busy, setBusy] = React40.useState(false);
        ...
        async function submit(event) {
          ...
          try {
            await request2(
              row ? `${endpoint3}/${encodeURIComponent(row.id)}` : endpoint3,
              {
        ...
        const field = (label, child) => h36(Field2, { label }, child);
        return h36(
          "form",
          {
                    ...
                    row?.schedule.kind === "once"
                      ? new Date(
                          new Date(row.schedule.at).getTime() -
                            new Date(row.schedule.at).getTimezoneOffset() * 6e4,
                        )
                          .toISOString()
                          .slice(0, 16)
                      : "",
      ...
      function Page() {
        const { confirm, confirmation } = useConfirm();
        const [state, refresh] = useResource2(endpoint3);
        ...
        const [editing, setEditing] = React40.useState(void 0);
        const [editorRevision, setEditorRevision] = React40.useState(0);
        const [history2, setHistory] = React40.useState({});
        const [error, setError] = React40.useState("");
        const [busy, setBusy] = React40.useState(false);
        ...
        async function loadHistory(id) {
          try {
            const rows = await request2(
              `${endpoint3}/${encodeURIComponent(id)}/runs`,
            );
        ...
        return h36(
          ...
          h36(
            ...
            h36(
              "div",
              null,
              h36("h3", null, "让日常工作，自动进行"),
              h36(
                "p",
                null,
                "按指定时间一次执行，或按间隔、每周、Cron 重复执行。",
              ),
            ),
          ),
          editing !== null
            ...
            h36(
              ...
              h36(
                Button2,
                {
                  ...
                  onClick: async () => {
                    await action(
                      `${endpoint3}/${encodeURIComponent(row.id)}/run`,
                      "POST",
                    );
                          ...
                          h36(
                            ...
                            run.result
                              ? h36(
                                  "details",
                                  null,
                                  h36("summary", null, "执行结果"),
                                  h36("pre", null, run.result),
                                )
                              : null,
                            run.skillSuggestionPath
                              ...
                              : null,
                            ["pending", "waiting", "running"].includes(
                              run.status,
                            )
                              ? h36(
                                  Button2,
                                  {
                                    ...
                                    onClick: async () => {
                                      await action(
                                        `${endpoint3}/${encodeURIComponent(row.id)}/runs/${encodeURIComponent(run.id)}/cancel`,
                                        "POST",
                                      );
                                      await loadHistory(row.id);
                                    },
    ...
    function UploadSettings() {
      ...
      return (0, import_react16.createElement)(
        ...
        (0, import_react16.createElement)(Switch, {
    ...
    function BusyEnterSettings() {
      ...
      return (0, import_react16.createElement)(
        ...
        (0, import_react16.createElement)(Select, {
    ...
    function createMessageDelivery(React40) {
      ...
      function useRows(id) {
        return React40.useSyncExternalStore(
          React40.useCallback((listener) => {
            listeners.add(listener);
            return () => listeners.delete(listener);
          }, []),
          React40.useCallback(() => get(id), [id]),
        );
      }
    ...
    var messageDelivery = createMessageDelivery(import_react17.default);
    ...
    var RuntimeServices = import_react18.default.createContext(null);
    ...
    function useNativeConversation(ctx, sessionId2, enabled) {
      ...
      const refresh = import_react18.default.useRef(async () => {});
      const reload = import_react18.default.useCallback(
        () => refresh.current(),
        [],
      );
    ...
    function createUploads({
      ...
      async function uploadFile(
        ...
        const base = endpoint3(workspaceId);
      ...
      function Panel({ workspaceId, onChanged }) {
        const [rows, setRows] = React40.useState([]);
        const [progress, setProgress] = React40.useState({});
        const [error, setError] = React40.useState("");
        const [active, setActive] = React40.useState(null);
        const control = React40.useRef(null);
        async function refresh() {
          try {
            setRows(await request2(endpoint3(workspaceId)));
            setError("");
          } catch (reason) {
            setError(friendlyError2(reason.message));
          }
        ...
        React40.useEffect(() => {
          let live = true;
          request2(endpoint3(workspaceId))
            .then((rows2) => {
        ...
        return h36(
          ...
          h36(
            ...
            null,
            h36("span", null, "待继续上传"),
            h36("small", null, rows.length),
          ),
          h36("button", { type: "button", onClick: refresh }, "刷新上传列表"),
          h36("p", null, "重新选择原文件可继续；未完成上传保留 7 天。"),
          error ? h36("p", { role: "alert" }, error) : null,
          ...rows.map((row) =>
            h36(
              "article",
              { key: row.id },
              h36("strong", null, row.name),
              h36("progress", {
                max: row.size || 1,
      ...
      function Area({ workspaceId, directory, onChanged, children, ...props }) {
        const input = React40.useRef(null);
        const control = React40.useRef(null);
        const live = React40.useRef(true);
        const [progress, setProgress] = React40.useState(null);
        const [error, setError] = React40.useState("");
        ...
        return h36(
          ...
          progress
            ...
            : null,
          error ? h36("p", { role: "alert" }, error) : null,
          h36(Panel, { workspaceId, onChanged }),
          children,
        );
      }
    ...
    function createFileComposer({
      ...
      return function FileComposer({
        ...
        const savedRange = React40.useRef(null);
        const change = React40.useRef(onChange);
        change.current = onChange;
        const history2 = React40.useRef({
          current: value,
          past: [],
          future: [],
          group: null,
    ...
    function createWorkbench({
      ...
      const button = (label, onClick, props = {}) =>
        h36("button", { type: "button", onClick, ...props }, label);
      ...
      function useDraft(sessionId2, authorized = true) {
        ...
        const [state, update] = React40.useState(() => ({
          key,
      ...
      function Mermaid({ code }) {
        const [result, setResult] = React40.useState(null);
        const [source, setSource] = React40.useState(false);
        const [theme, setTheme] = React40.useState(() =>
        ...
        const id = React40.useId().replaceAll(":", "");
        React40.useEffect(() => {
          let live = true;
          setResult(null);
          const mermaidURL =
        ...
        return h36(
          ...
          source || result?.error
            ? h36(primitives2.CodeBlock, { code, lang: "mermaid" })
            : result?.svg
              ? h36("div", { dangerouslySetInnerHTML: { __html: result.svg } })
              : h36("p", { role: "status" }, "正在绘制图表…"),
          result?.error ? h36("figcaption", null, result.error) : null,
        );
      }
      ...
      function Markdown2({ children, streaming = false, workspaceId }) {
        const [error, setError] = React40.useState("");
        const root = React40.useRef(null);
        ...
        const rendered = chunks
          .map((chunk, index) => {
            ...
            if (diagram && !streaming)
              diagrams.push(h36(Mermaid, { key: index, code: diagram[2] }));
        ...
        return h36(
          ...
          h36(primitives2.MarkdownText, {
            text: rendered,
            streaming,
            codeLabels: { copyLabel: "复制代码", copiedLabel: "已复制" },
          }),
          ...diagrams,
          error ? h36("small", { role: "alert" }, error) : null,
        );
      }
      ...
      function Artifacts({ sessionId: sessionId2, workspaceId, revision }) {
        const [rows, setRows] = React40.useState([]);
        const [fileRevision, setFileRevision] = React40.useState(0);
        React40.useEffect(() => {
        ...
        return rows.length
          ? h36(
              ...
              h36("summary", null, `会话产物 · ${rows.length}`),
              ...rows.map((row) =>
                h36(
                  "div",
                  { key: row.id },
      ...
      function Tools({ tools = {}, workspaceId }) {
        ...
        return h36(
          ...
          h36("summary", null, `工具过程 · ${rows.length}`),
          rows.map((tool) =>
            h36(
              "details",
              { key: tool.toolCallId },
        ...
        return h36(
          ...
          ...rows.map((row) =>
            h36(
              ...
              row.text
                ? h36("p", { style: { whiteSpace: "pre-wrap" } }, row.text)
                : null,
      ...
      function Question({
        ...
        const heading = React40.useId();
        const [reply, setReply] = useDraft(`${sessionId2}:question:${id}`);
        const [pending, setPending] = React40.useState(false);
        const [status, setStatus] = React40.useState("");
        const sending = React40.useRef(false);
        const submit = async (event) => {
          event.preventDefault();
        ...
        if (answered)
          return h36(
            ...
            h36(
              "details",
              null,
              h36("summary", null, "✓ 已补充"),
              ...React40.Children.toArray(children),
            ),
          );
        return h36(
          "article",
      ...
      function SessionReminder({ sessionId: sessionId2, onSaved }) {
        const [state, setState] = React40.useState(null);
        ...
        return h36(
          ...
          h36(
            "label",
            { className: "workagent-field workagent-session-reminder-field" },
            h36(
              "span",
              { className: "workagent-session-reminder-label" },
              Icon2 ? h36(Icon2, { name: "notifications", size: 14 }) : null,
              "提醒渠道",
            ),
            h36(
              "select",
          ...
          !(state?.targets || []).some((target) => target.connected)
            ? h36(
                "p",
                { className: "workagent-session-reminder-hint" },
                "暂无可选聊天，请先在消息渠道中连接账号，并从目标聊天给机器人发送一条消息。",
              )
            : null,
          h36(
            "div",
            { className: "workagent-session-reminder-footer" },
            h36(
              "button",
              {
                type: "button",
      ...
      function Controls({ ctx, session, busy, cancel }) {
        const [permission, setPermission] = React40.useState(
        ...
        const [catalog, setCatalog] = React40.useState(null);
        const [pending, setPending] = React40.useState([]);
        ...
        return h36(
            ...
            h36(
              ...
              h36(
                ...
                ...[
                  ...
                  .map(([id, label]) =>
                    h36("option", { key: id, value: id }, label),
                  ),
              ),
            ),
          ),
          pending.map((item) =>
            h36(
              ...
              h36("strong", null, `需要授权 · ${item.tool}`),
              h36("p", null, item.summary),
              item.input !== void 0
                ? h36(
                    "details",
                    null,
                    h36("summary", null, "操作详情"),
                    h36(primitives2.CodeBlock, {
          ...
          error ? h36("span", { role: "alert" }, error) : null,
        );
      }
      function usePins(key = "workagent.session-pins.v1") {
        const [pins, setPins] = React40.useState(() =>
      ...
      function Notifications({ sessions = [], settings = true }) {
        const [enabled, setEnabled] = React40.useState(() =>
          readStored(localStorage, "workagent.browser-notifications", false),
        );
        const [error, setError] = React40.useState("");
        const known = React40.useRef(/* @__PURE__ */ new Map());
        React40.useEffect(() => {
          const sync = () =>
            setEnabled(
              readStored(
        ...
        return h36(
          ...
          error ? h36("small", { role: "status" }, error) : null,
        );
      }
      function ComposerTools({
        ...
        const uploadInput = React40.useRef(null);
        const uploadToProject = useUploadToProject2();
        const uploadControl = React40.useRef(null);
        const [uploadProgress, setUploadProgress] = React40.useState(null);
        const [uploading, setUploading] = React40.useState(false);
        const [directory, setDirectory] = React40.useState("");
        const [entries, setEntries] = React40.useState([]);
        const [filesOpen, setFilesOpen] = React40.useState(false);
        const [commandsOpen, setCommandsOpen] = React40.useState(false);
        const [nativeCommands, setNativeCommands] = React40.useState([]);
        const [fileCursor, setFileCursor] = React40.useState(null);
        const [findingFiles, setFindingFiles] = React40.useState(false);
        const mention = /(?:^|\s)@([^\s]*)$/.exec(input)?.[1];
        const slash = /^\/([^\s]*)$/.exec(input);
        const showingFiles = filesOpen || mention !== void 0;
        const workspaceId = session?.workspaceId;
        const fileSearchKey = React40.useRef("");
        const fileSearch = React40.useRef(null);
        const pageRequest = React40.useRef(null);
        ...
        const nextFilePage = async () => {
          ...
          try {
            ...
            if (!abort.signal.aborted) onError(friendlyError2(error.message));
          } finally {
        ...
        React40.useEffect(() => {
          ...
          const refresh = async () => {
            try {
              const catalog = await request2(
                `${apiRoot2}/sessions/${encodeURIComponent(session.id)}/commands`,
                { signal: abort.signal },
              );
              ...
              if (!abort.signal.aborted) timer = setTimeout(refresh, 2e3);
            }
          };
          void refresh();
          return () => {
...
`,
        ...
        return h36(
          ...
          button(
            Icon2 ? h36(Icon2, { name: "plus", size: 18 }) : "+",
          ...
          h36(Voice, { setInput, onError, disabled: disabled || uploading }),
          uploadProgress
            ? h36(
                "div",
                null,
          ...
          showingFiles
            ? h36(
                ...
                entries
                  ...
                  .map((entry) =>
                    button(
                      `${entry.kind === "directory" ? "▸ " : ""}${mention === void 0 ? entry.name : entry.path}`,
                      () => {
      ...
      function Voice({ setInput, onError, disabled }) {
        const [capability, setCapability] = React40.useState(null);
        const [state, setState] = React40.useState("idle");
        const recording = React40.useRef(null);
        const live = React40.useRef(true);
        React40.useEffect(() => {
          live.current = true;
      ...
      function TextEditor({
        ...
        const { confirm, confirmation } = useConfirm();
        const [draft] = React40.useState(() =>
          readStored(sessionStorage, key, null),
        );
        const [base] = React40.useState(draft?.base ?? original);
        const [text, setText] = React40.useState(draft?.text ?? original);
        const [diff, setDiff] = React40.useState(false);
        const [busy, setBusy] = React40.useState(false);
        const [error, setError] = React40.useState("");
        const dirty = text !== base;
        const leaseOwner = React40.useRef(crypto.randomUUID());
        React40.useEffect(() => {
          if (!dirty) return;
        ...
        (0, import_react21.createElement)(
          ...
          onPin
            ? (0, import_react21.createElement)(
                ...
                (0, import_react21.createElement)(Icon, { name: "pin" }),
                pinned ? "取消置顶" : "置顶对话",
              )
            : null,
          onReminder
          ...
          (0, import_react21.createElement)(
            ...
            (0, import_react21.createElement)(Icon, { name: "edit" }),
            "管理对话",
          ),
        ),
        error
    ...
    function ConversationManagementDialog({
      ...
      return (0, import_react21.createElement)(
        ...
        deleting
          ? (0, import_react21.createElement)("p", null, deleteDescription)
          : (0, import_react21.createElement)(Input, {
              "aria-label": "对话名称",
              autoFocus: true,
              value: name,
    ...
    function SidebarPin({ pinned = true }) {
      return (0, import_react22.createElement)(Icon, {
        name: "pin",
        size: 14,
    ...
    function SidebarAction({ label, icon = "more", children, ...props }) {
      return (0, import_react22.createElement)(
        ...
        children ||
          (icon === "pin"
            ? (0, import_react22.createElement)(SidebarPin, {
                pinned: props["aria-pressed"] === true,
              })
            : (0, import_react22.createElement)(Icon, {
                name: icon,
                size: 14,
              })),
      );
    ...
    function SidebarRow({
      title,
      subtitle,
      icon = (0, import_react22.createElement)(Icon, {
        name: "chat",
        size: 16,
      }),
      status,
        ...
        (0, import_react22.createElement)(
          ...
          meta || pinned
            ? (0, import_react22.createElement)(
                ...
                meta,
                pinned ? (0, import_react22.createElement)(SidebarPin) : null,
              )
            : null,
        ),
        actions,
    ...
    function SidebarGroup({
      ...
      return (0, import_react22.createElement)(
        ...
        (0, import_react22.createElement)(SidebarRow, {
          kind: "project",
          title,
          icon: (0, import_react22.createElement)(
            "span",
        ...
        heading ||
          (onToggle
            ? (0, import_react22.createElement)(
                ...
                (0, import_react22.createElement)("span", null, title),
              )
            : (0, import_react22.createElement)(
                "span",
    ...
    function FileIconButton({ name, label, ...props }) {
      return (0, import_react24.createElement)(
        ...
        (0, import_react24.createElement)(Icon, { name, size: 17 }),
      );
    }
    ...
    function DocxPreview({ title, html, data }) {
      const frame = import_react23.default.useRef(null);
      const sendTypography = import_react23.default.useCallback(() => {
      ...
      return (0, import_react24.createElement)("iframe", {
        ref: frame,
        title,
    ...
    function WorkspaceFilePreview({
      ...
      const [source, setSource] = import_react23.default.useState(false);
      const [editingFile, setEditingFile] =
        import_react23.default.useState(false);
      const [maximized, setMaximized] = import_react23.default.useState(false);
      const locatedLine = import_react23.default.useRef(null);
      import_react23.default.useEffect(() => {
      ...
      const reportDirty = import_react23.default.useCallback(
      ...
      return (0, import_react24.createElement)(
        ...
        (0, import_react24.createElement)(
          "header",
          null,
          (0, import_react24.createElement)(FileIconButton, {
            name: "back",
            label: "返回文件列表",
            onClick: onClose,
          }),
        ...
        (0, import_react24.createElement)(
          ...
          editingFile && state.text !== void 0
            ? (0, import_react24.createElement)(workbench.TextEditor, {
                key: entry.path,
            ...
            : state.loading
              ...
              : state.error
                ...
                : state.media === "docx"
                  ? (0, import_react24.createElement)(DocxPreview, {
                  ...
                  : state.media === "image"
                    ? (0, import_react24.createElement)("img", {
                        src: state.url,
                        alt: entry.name,
                      })
                    : state.media === "pdf"
                      ? (0, import_react24.createElement)("iframe", {
                          src: state.url,
                          title: entry.name,
                        })
    ...
    function createShared({
      ...
      const icon = (name, size = 18) =>
        Icon2 ? h36(Icon2, { name, size }) : null;
      const assistantAvatar = (backend, fallback) =>
        EngineMark2
          ? h36(EngineMark2, { engine: backend || "harness" })
          : fallback;
      ...
      const useShared = () =>
        React40.useSyncExternalStore(subscribe, () => snapshot);
      ...
      function PersonalTaskButton({ project, onClose }) {
        return h36(
          ...
          h36(
            "span",
            null,
            h36("strong", null, "个人任务"),
            h36("small", null, "仅自己可见 · 在项目共享文件夹中运行"),
          ),
      ...
      function useMembers(project, revision) {
        const [members, setMembers] = React40.useState([]);
        React40.useEffect(() => {
          if (!project) {
            setMembers([]);
            return;
      ...
      function MoreMenu({ children }) {
        ...
        return h36(
          ...
          h36("summary", { "aria-label": "项目更多操作" }, icon("more", 16)),
          h36(
            "div",
            {
      ...
      function UserSearch({ onSelect, selected = [] }) {
        const [query, setQuery] = React40.useState(""),
          [results, setResults] = React40.useState([]),
          [error, setError] = React40.useState("");
        React40.useEffect(() => {
          setResults([]);
      ...
      function CreateProject({ onClose, onCreated }) {
        const [name, setName] = React40.useState(""),
          [invitees, setInvitees] = React40.useState([]);
        const [busy, setBusy] = React40.useState(false),
          [error, setError] = React40.useState("");
        const operation = React40.useRef(uid()),
          created = React40.useRef(null);
        ...
        return h36(
          ...
          h36(
            ...
            h36(
              "footer",
              null,
              h36(Button2, { onClick: onClose, disabled: busy }, "取消"),
              h36(
                Button2,
                {
                  type: "submit",
      ...
      function Invitations({ onClose }) {
        ...
        const [busy, setBusy] = React40.useState(""),
          [error, setError] = React40.useState("");
            ...
            ...pending.map((invite) =>
              h36(
                ...
                h36(
                  "div",
                  null,
                  h36("strong", null, invite.projectName),
                  h36("p", null, `${invite.inviterName} 邀请你加入`),
                  h36(
                    "small",
                    null,
      ...
      function AssistantMembers({ project, revision }) {
        ...
        const [selected, setSelected] = React40.useState(""),
          [busy, setBusy] = React40.useState(false),
          [notice, setNotice] = React40.useState(""),
          [error, setError] = React40.useState("");
        ...
        return h36(
          ...
          project.currentRole === "owner"
            ? h36(
                ...
                h36(
                  ...
                  h36("option", { value: "" }, "选择要邀请的助手"),
                  ...available.map((row) =>
                    h36("option", { key: row.id, value: row.id }, row.name),
                  ),
                ),
                h36(
                  Button2,
            ...
            : null,
          h36(Feedback, { error: error || state.error, notice }),
          ...state.members.map((member) =>
            h36(
              ...
              h36(
                "div",
                null,
                h36("strong", null, member.name),
                h36("small", null, `${member.assistant_backend} · 已加入`),
              ),
              project.currentRole === "owner"
                ? h36(
                    Button2,
          ...
          !state.members.length
            ? h36("p", null, "邀请助手加入后，成员才能 @ 它。")
            : null,
        );
      }
      function AssistantSettingsRow({ project, member, options }) {
        const [model, setModel] = React40.useState(member.model_id),
          [effort, setEffort] = React40.useState(member.thinking_effort),
          [busy, setBusy] = React40.useState(false),
          [error, setError] = React40.useState(""),
          [notice, setNotice] = React40.useState("");
        React40.useEffect(() => {
        ...
        return h36(
          ...
          h36(
            ...
            null,
            h36("strong", null, member.name),
            h36("small", null, ` · ${member.assistant_backend}`),
          ),
          h36(
            "label",
            null,
          ...
          h36(
            ...
            h36(
              ...
              ...levels.map(({ id, name }) =>
                h36("option", { key: id, value: id }, levelLabels[id] || name),
              ),
            ),
          ),
          member.running
            ? h36("p", null, "助手正在执行，结束后可调整设置。")
            : null,
          h36(Feedback, { error, notice }),
          h36(
            Button2,
            {
              type: "submit",
      ...
      function AssistantSettings({ project, revision, onClose }) {
        ...
        return h36(
          ...
          h36(
            ...
            h36(Feedback, { error: state.error }),
            ...state.members.map((member) =>
              h36(AssistantSettingsRow, {
                key: member.assistant_id,
                project,
                member,
      ...
      function Members({ project, members, revision, onClose }) {
        const { confirm, confirmation } = useConfirm();
        const [outgoing, setOutgoing] = React40.useState([]),
          [selected, setSelected] = React40.useState(null),
          [busy, setBusy] = React40.useState(false);
        const [notice, setNotice] = React40.useState(""),
          [error, setError] = React40.useState(""),
          [link, setLink] = React40.useState(null);
          ...
          h36(
            ...
            owner
              ? h36(
                  React40.Fragment,
                  null,
                  h36(UserSearch, { onSelect: setSelected }),
                  selected
                    ? h36(
                        "div",
                        { className: "workagent-collab-actions" },
              ...
              : null,
            h36(Feedback, { notice, error }),
            h36(AssistantMembers, { project, revision }),
            h36(
              "div",
              ...
              ...members.map((member) =>
                h36(
                  ...
                  h36(
                    "div",
                    null,
                    h36("strong", null, member.displayName || member.username),
                    h36(
                      "small",
                      null,
              ...
              ? h36(
                  ...
                  ...outgoing.map((invite) =>
                    h36(
                      ...
                      h36("span", null, invite.displayName || invite.username),
                      h36(
                        "small",
                        null,
      ...
      function Composer({
        ...
        const [body, setBody] = React40.useState(initial),
          [mentions, setMentions] = React40.useState([]),
          [caret, setCaret] = React40.useState(initial.length),
          [choice, setChoice] = React40.useState(0);
        const [busy, setBusy] = React40.useState(false),
          [uploading, setUploading] = React40.useState(false),
          [attachments, setAttachments] = React40.useState([]),
          [error, setError] = React40.useState(""),
          [notice, setNotice] = React40.useState("");
        const messageID = React40.useRef(null),
          textarea = React40.useRef(null);
        React40.useLayoutEffect(() => {
        ...
        const uploadControl = React40.useRef(null);
        React40.useEffect(() => () => uploadControl.current?.abort(), []);
              ...
              ? h36(
                  ...
                  ...candidates.map((candidate, index) =>
                    h36(
                      ...
                      h36("strong", null, candidate.name),
                      h36(
                        "small",
                        null,
          ...
          h36(
            ...
            !messages.length
              ? h36(
                  ...
                  icon("chat", 32),
                  h36("h2", null, "一起把事情做好"),
                  h36("p", null, "在这里讨论、分享文件，需要助手时再 @ 它。"),
                )
              : null,
            ...messages.map((message) =>
              h36(
                ...
                h36(
                  ...
                  h36(Markdown2, null, message.body),
                ),
      ...
      function Files({ project, onClose, revision }) {
        const [wide, setWide] = React40.useState(false);
      ...
      function Sidebar() {
        ...
        const [creating2, setCreating] = React40.useState(false),
          [invites, setInvites] = React40.useState(false),
          [searching, setSearching] = React40.useState(false),
          [collapsed, setCollapsed] = React40.useState({}),
          [sectionClosed, setSectionClosed] = React40.useState(false),
          [menu, setMenu] = React40.useState(null),
          [action, setAction] = React40.useState(null),
          [name, setName] = React40.useState(""),
          [busy, setBusy] = React40.useState(false),
          [query, setQuery] = React40.useState(""),
          [hidden, setHidden] = React40.useState(false),
          [error, setError] = React40.useState("");
        ...
        const menuItem = (label, glyph, onClick) =>
          h36(Button2, { disabled: busy, onClick }, icon(glyph, 16), label);
        return h36(
          "section",
          {
          ...
          count
            ? h36(
                ...
                "项目邀请",
                h36("span", { className: "workagent-badge" }, count),
              )
            : null,
          h36(Feedback, { error: error || state.error }),
          h36(
            "div",
                ...
                ...discussions.map((discussion) => {
                  ...
                  return h36(SidebarRow, {
                    ...
                    icon: personalTask
                      ...
                      : icon("teams", 16),
                    meta: personalTask
                      ? h36("span", { className: "workagent-badge" }, "个人")
                      : null,
                    pinned: personalTask && !!discussion.pinned,
                    status: h36(SidebarStatus, {
          ...
          action?.discussion?.kind === "personal_task"
            ? h36(ConversationManagementDialog, {
                name,
            ...
            : action && !["members", "manage-discussions"].includes(action.kind)
              ...
              : null,
          creating2
            ? h36(CreateProject, { onClose: () => setCreating(false) })
            : null,
          invites
            ? h36(Invitations, { onClose: () => setInvites(false) })
            : null,
          confirmation,
        );
      }
      function Page() {
        ...
        const [modal, setModal] = React40.useState(""),
          [files, setFiles] = React40.useState(false),
          [error, setError] = React40.useState(""),
          [notice, setNotice] = React40.useState(""),
          [name, setName] = React40.useState(""),
          [busy, setBusy] = React40.useState(false);
        const discussionOperation = React40.useRef(uid());
        React40.useEffect(() => {
          setModal(
            params.has("token") ||
              params.has("invite") ||
        ...
        return h36(
                      ...
                      ? h36(
                          ...
                          h36(
                            ...
                            h36(
                              ...
                              icon("notifications", 16),
                              h36("strong", null, "消息提醒"),
                            ),
                            h36(
                              "p",
                              {
                                className:
                                  "workagent-collab-reminder-description",
                              },
                              "仅接收 Agent 完成提醒和产物文件。",
                            ),
                            h36(SessionReminder, {
          ...
          modal === "create"
            ? h36(CreateProject, { onClose: () => setModal("") })
            : null,
          modal === "invites"
            ? h36(Invitations, {
                onClose: () => {
            ...
            ? h36(
                ...
                h36(
                  ...
                  h36(
                    "footer",
                    null,
                    h36(Button2, { onClick: () => setModal("") }, "取消"),
                    h36(
                      Button2,
                      {
                        type: "submit",
      ...
      function Hero({ onExit, initial = "" }) {
        const state = useShared(),
          [projectId, setProjectId] = React40.useState(""),
          [creating2, setCreating] = React40.useState(false),
          [pending, setPending] = React40.useState(null);
        ...
        return h36(
          ...
          h36(
            ...
            h36(Button2, { onClick: () => setCreating(true) }, "创建项目"),
            h36(
              "label",
    ...
    function ComposerInput(props) {
      return (0, import_react26.createElement)(workbench.FileComposer, props);
    }
    function ComposerForm({
      ...
      const formRef = import_react25.default.useRef(null);
    ...
    function createFileMoves({
      ...
      function useFileMoves2({
        ...
        const [picker, setPicker] = React40.useState(null);
        const [target, setTarget] = React40.useState("");
        const [folders, setFolders] = React40.useState([]);
        const [folderName, setFolderName] = React40.useState("");
        const [hover, setHover] = React40.useState(null);
        ...
        const drag = React40.useRef(null);
        const accept = (op) => {
          ...
          controls: h36(
            ...
            ...pending.map((op) =>
              h36(
                ...
                h36("span", null, "已安排移动，等待任务结束或文件编辑保存。"),
            ...
            picker
              ? h36(
                  ...
                  h36("strong", null, `移动 ${picker.length} 项到…`),
                  h36(
                    "nav",
                    { "aria-label": "目标文件夹" },
    ...
    function createFileTrash({
      ...
      function useFileTrash2({ root, enabled }) {
        const [data, setData] = React40.useState(null);
        const [loading, setLoading] = React40.useState(false);
        const [busy, setBusy] = React40.useState(false);
        const [error, setError] = React40.useState("");
        const [notice, setNotice] = React40.useState("");
        const [menu, setMenu] = React40.useState(null);
        const [action, setAction] = React40.useState(null);
        const pending = React40.useRef(null);
        const live = React40.useRef(false);
        ...
        const mutate2 = async (event) => {
          ...
          try {
            const endpoint3 = `${root}/${encodeURIComponent(entry.id)}`;
            await request2(
              kind === "restore" ? `${endpoint3}/restore` : endpoint3,
              {
        ...
        const content = h36(
          ...
          h36(
            ...
            h36(
              ...
              h36("strong", null, "文件恢复"),
              h36("span", null, `保留 ${data?.retentionDays || 7} 天`),
            ),
            h36(
              "p",
              null,
          ...
          data
            ? h36(
                ...
                h36("strong", null, `本项目 · ${data.entries.length} 项`),
                h36("span", null, storageSize(data.projectUsedBytes)),
              )
            : null,
          h36(
            "div",
            ...
            !data
              ? error
                ? h36(
                    "div",
                    { className: "workagent-file-panel-empty" },
                    h36(Icon2, { name: "trash", size: 32 }),
                    h36("strong", null, "暂时无法读取回收站"),
                    h36(
                      Button2,
                    ...
                    ...data.entries.map((entry) =>
                      h36(
                        ...
                        h36(
                          ...
                          h36("small", null, storageSize(entry.size)),
                          h36(FileIconButton2, {
                            name: "more",
                            label: `操作 ${entry.name}`,
                            "aria-expanded": menu === entry.id,
    ...
    var { useFileMoves } = createFileMoves({
      ...
      request,
      h: import_react28.createElement,
      friendlyError,
    });
    ...
    function WorkspaceFileManager({
      ...
      const [tree, setTree] = import_react27.default.useState({});
      const [searchQuery, setSearchQuery] = import_react27.default.useState("");
      const [searchRows, setSearchRows] = import_react27.default.useState([]);
      const [searchCursor, setSearchCursor] =
        import_react27.default.useState(null);
      const [searchBusy, setSearchBusy] =
        import_react27.default.useState(false);
      const [searchChoice, setSearchChoice] =
        import_react27.default.useState(0);
      const searchAbort = import_react27.default.useRef(null);
      const searchLease = import_react27.default.useRef(null);
      const releaseSearch = () => {
      ...
      const { confirm, confirmation } = useConfirm();
      const [trashOpen, setTrashOpen] = import_react27.default.useState(false);
      const trash = useFileTrash({ root: trashRoot, enabled: trashOpen });
      const [expanded, setExpanded] = import_react27.default.useState(
        /* @__PURE__ */ new Set([""]),
      );
      const [directory, setDirectory] = import_react27.default.useState("");
      const [selected, setSelected] = import_react27.default.useState(null);
      const [tabs, setTabs] = import_react27.default.useState([]);
      const [dirtyFiles, setDirtyFiles] = import_react27.default.useState(
        /* @__PURE__ */ new Set(),
      );
      const reportDirty = import_react27.default.useCallback(
        (path, value) =>
      ...
      const [menu, setMenu] = import_react27.default.useState(null);
      const [action, setAction] = import_react27.default.useState(null);
      const [name, setName] = import_react27.default.useState("");
      const [busy, setBusy] = import_react27.default.useState(false);
      const [loading, setLoading] = import_react27.default.useState(false);
      const [error, setError] = import_react27.default.useState("");
      const [notice, setNotice] = import_react27.default.useState("");
      const [revision, setRevision] = import_react27.default.useState(0);
      const uploadInput = import_react27.default.useRef(null);
      const uploadControl = import_react27.default.useRef(null);
      ...
      const requests = import_react27.default.useRef(/* @__PURE__ */ new Map());
      const live = import_react27.default.useRef(true);
      const expandedRef = import_react27.default.useRef(expanded);
      expandedRef.current = expanded;
      const loadDirectory = import_react27.default.useCallback(
        async (path) => {
      ...
      const refresh = import_react27.default.useCallback(async () => {
        setLoading(true);
            ...
            (0, import_react28.createElement)(
              ...
              (0, import_react28.createElement)(
                ...
                (0, import_react28.createElement)(
                  ...
                  (0, import_react28.createElement)("span", null, entry.name),
                ),
                entry.kind === "file"
                  ? (0, import_react28.createElement)(
                      "small",
                  ...
                  : null,
                (0, import_react28.createElement)(FileIconButton, {
                  name: "more",
                  label: `操作 ${entry.name}`,
      ...
      return (0, import_react28.createElement)(
        ...
        (0, import_react28.createElement)(
          ...
          uploadProgress
            ? (0, import_react28.createElement)(
                ...
                { className: "workagent-upload-progress" },
                uploadProgress.name,
                (0, import_react28.createElement)("progress", {
                  max: uploadProgress.size || 1,
                  value: uploadProgress.bytes,
                }),
                (0, import_react28.createElement)(
          ...
          !trashOpen
            ? (0, import_react28.createElement)(uploadClient.Panel, {
                workspaceId: workspace.id,
                onChanged: refresh,
              })
            : null,
          ...
          !trashOpen && action
            ? (0, import_react28.createElement)(
                ...
                (0, import_react28.createElement)("strong", null, actionLabel),
                action.kind === "delete"
                  ? (0, import_react28.createElement)(
                      "p",
                      null,
        ...
        ...tabs.map((entry) =>
          (0, import_react28.createElement)(
            ...
            (0, import_react28.createElement)(WorkspaceFilePreview, {
              workspace,
              entry,
    ...
    function ResizeHandle({
      ...
      const start = import_react30.default.useRef(null);
      ...
      return (0, import_react31.createElement)("div", {
    ...
    var sessionId = (endpoint3) => endpoint3.split("/")[5];
    var cache = {
      get: (endpoint3) =>
        conversationCache.get(sessionId(endpoint3), endpoint3),
      set: (endpoint3, value) =>
        conversationCache.set(sessionId(endpoint3), endpoint3, value),
      remove: (endpoint3) => conversationCache.remove(sessionId(endpoint3)),
    };
    function useSessionResource(endpoint3, select) {
      return useResource(endpoint3, select, endpoint3 ? cache : void 0);
    }
    ...
    function MessageActions({ message, disabled, onEdit, onFork }) {
      const [copyState, setCopyState] = import_react32.default.useState("");
      ...
      const action = (name, icon, onClick, unavailable = false) =>
        (0, import_react33.createElement)(
          ...
          (0, import_react33.createElement)(Icon, { name: icon, size: 16 }),
        );
    ...
    function ConversationMessageTarget({ sessionId: sessionId2 }) {
      ...
      const locateMessage = import_react34.default.useCallback((messageId) => {
    ...
    function RuntimeConversation({
      ...
      const submitGesture = import_react34.default.useRef(false);
      ...
      const ctx = import_react34.default.useContext(RuntimeServices);
      const standard = hasStandardSessions(ctx);
      const native =
        standard &&
        ["codex", "kimi", "acp"].includes(sessionState.rows[0]?.engine);
      ...
      const messageState = native
        ...
        : legacyMessageState;
      const messageList = import_react34.default.useRef(null);
      ...
      const scrollReceipt = import_react34.default.useRef(null);
      ...
      const historyCursor = import_react34.default.useRef({
        index: -1,
        saved: "",
      });
      const retryDraft = import_react34.default.useRef(null);
      const currentInput = import_react34.default.useRef(input);
      currentInput.current = input;
      const [draft, setDraft] = import_react34.default.useState("");
      const [busy, setBusy] = import_react34.default.useState(false);
      const [progress, setProgress] = import_react34.default.useState("");
      const [error, setError] = import_react34.default.useState("");
      const [submitting, setSubmitting] =
        import_react34.default.useState(false);
      const [forkTarget, setForkTarget] = import_react34.default.useState(null);
      const [attachmentsBusy, setAttachmentsBusy] =
        import_react34.default.useState(false);
      const [editing, setEditing] = import_react34.default.useState(null);
      const [editContent, setEditContent] = import_react34.default.useState("");
      const session = native
        ? { ...sessionState.rows[0], ...nativeState.value?.metadata }
        : sessionState.rows[0];
      const activityRevision = import_react34.default.useRef(0);
      import_react34.default.useEffect(() => {
        if (!native) return;
      ...
      const syncActivity = import_react34.default.useCallback(async () => {
      ...
      const [questionReplies, setQuestionReplies] =
        import_react34.default.useState({
          sessionId: sessionId2,
          rows: [],
        });
      ...
      return (0, import_react35.createElement)(
        ...
        forkTarget
          ? (0, import_react35.createElement)(
              Dialog,
              {
                title: "从这里创建分支？",
              ...
              (0, import_react35.createElement)(
                ...
                (0, import_react35.createElement)(Icon, {
                  name: "branch",
                  size: 28,
                }),
                (0, import_react35.createElement)(
        ...
        side
          ...
          : (0, import_react35.createElement)(
              ...
              session
                ? (0, import_react35.createElement)(SessionAvatar, { session })
                : null,
              (0, import_react35.createElement)(
                "div",
                null,
                (0, import_react35.createElement)(
                  ...
                  session
                    ? session.workspaceId?.startsWith("shared:")
                      ? (0, import_react35.createElement)(PersonalTaskTitle, {
                          session,
                        })
        ...
        staleSharedTask
          ? (0, import_react35.createElement)(StalePersonalTask, {
              sessionId: sessionId2,
            })
          : null,
        (0, import_react35.createElement)(
          ...
          (0, import_react35.createElement)(ConversationMessageTarget, {
            sessionId: sessionId2,
          }),
          ...
          ...questionMessages.map((message) =>
            message.role === "assistant" && message.kind === "question"
              ? (0, import_react35.createElement)(
                  ...
                  (0, import_react35.createElement)(MessageActions, {
                    message,
                    disabled: submitting,
                  }),
                )
              : (0, import_react35.createElement)(
                  ...
                  message.role === "assistant"
                    ? (0, import_react35.createElement)(SessionAvatar, {
                        session,
                      })
                    : null,
                  message.replyTo
                  ...
                  editing === message.id
                    ? (0, import_react35.createElement)(
                        ...
                        (0, import_react35.createElement)(ComposerInput, {
                          "aria-label": "编辑消息",
                          workspaceId: session?.workspaceId,
                          autoFocus: true,
                          value: editContent,
          ...
          visibleQueue.length
            ...
            : null,
          (0, import_react35.createElement)(workbench.Tools, {
            tools: nativeState.value?.tools,
            workspaceId: session?.workspaceId,
          }),
          (0, import_react35.createElement)(workbench.Artifacts, {
            sessionId: id,
            workspaceId: session?.workspaceId,
            revision: messageState.rows.length,
          }),
          (0, import_react35.createElement)(workbench.Process, {
          ...
          draft
            ...
            : busy
              ? (0, import_react35.createElement)(
                  ...
                  (0, import_react35.createElement)("span", null),
                  (0, import_react35.createElement)("span", null),
                  (0, import_react35.createElement)("span", null),
                  progress ||
                    (pending.some(
        ...
        (0, import_react35.createElement)(
          ...
          (0, import_react35.createElement)(workbench.ComposerTools, {
          ...
          (0, import_react35.createElement)(
            ...
            (0, import_react35.createElement)(workbench.Controls, {
              ctx,
              session,
              busy,
              cancel,
    ...
    function ConversationWorkspace({ sessionId: sessionId2 }) {
      const ctx = import_react36.default.useContext(RuntimeServices);
      const workspaceRef = import_react36.default.useRef(null);
      const [workspaceWidth, setWorkspaceWidth] =
        import_react36.default.useState(0);
      const [sideWidth, setSideWidth] = import_react36.default.useState(
        () => Number(localStorage.getItem("workagent.side-chat.width")) || null,
      );
      import_react36.default.useLayoutEffect(() => {
      ...
      const [sideId, setSideId] = import_react36.default.useState(() =>
        localStorage.getItem(`workagent.side-chat.${sessionId2}`),
      );
      const [opening, setOpening] = import_react36.default.useState(false);
      const [sideError, setSideError] = import_react36.default.useState("");
      const [deleteTarget, setDeleteTarget] =
        import_react36.default.useState(null);
      const [deleting, setDeleting] = import_react36.default.useState(false);
      const deletingRef = import_react36.default.useRef(false);
      const openingRef = import_react36.default.useRef(false);
      ...
      return (0, import_react37.createElement)(
        ...
        (0, import_react37.createElement)(RuntimeConversation, {
          key: sessionId2,
          sessionId: sessionId2,
        ...
        opening
          ...
          : null,
        sideId
          ? (0, import_react37.createElement)(ResizeHandle, {
        ...
        sideId
          ? (0, import_react37.createElement)(
              ...
              (0, import_react37.createElement)(RuntimeConversation, {
                ...
                sessionId: sideId,
                side: true,
                sideHeader: (0, import_react37.createElement)(
                  "header",
                  {
                    className:
                  ...
                  (0, import_react37.createElement)(
                    ...
                    (0, import_react37.createElement)(
                      ...
                      (0, import_react37.createElement)("strong", null, "侧聊"),
                      (0, import_react37.createElement)(
                        "span",
                    ...
                    (0, import_react37.createElement)(
                      ...
                      (0, import_react37.createElement)(
                        ...
                        (0, import_react37.createElement)(Icon, {
                          name: "plus",
                          size: 17,
                        }),
                      ),
                  ...
                  sideState.rows.length > 1
                    ? (0, import_react37.createElement)(
                        ...
                        (0, import_react37.createElement)(Select, {
                          "aria-label": "选择侧聊",
                          disabled: opening || deleting,
                          value: sideId,
                          onChange: (event) => {
    ...
    function MarketplaceDetail({ row, request: request2, explain, onClose }) {
      ...
      const [revision, setRevision] = import_react38.default.useState(0);
      ...
      return (0, import_react38.createElement)(
        ...
        quota
          ? (0, import_react38.createElement)(
              ...
              (0, import_react38.createElement)("h3", null, "我的调用次数"),
              (0, import_react38.createElement)(
                "p",
                { className: "workagent-muted" },
                    ...
                    (0, import_react38.createElement)(
                      ...
                      ...[
                        ...
                        (0, import_react38.createElement)(
                          ...
                          (0, import_react38.createElement)("h4", null, period),
                          (0, import_react38.createElement)(
                            "p",
                            null,
                            "剩余调用次数 / 总可调用次数",
    ...
    function createMarketplace({
      ...
      const endpoint3 = "/api/portal/marketplace",
      ...
      function MarketplaceSection2() {
        ...
        const [project, setProject] = React40.useState(
          () => new URLSearchParams(location.search).get("marketProject") || "",
        );
        const [subscriptions, setSubscriptions] = React40.useState([]),
          [canManage, setCanManage] = React40.useState(false);
        const [query, setQuery] = React40.useState(""),
          [kind, setKind] = React40.useState("all"),
          [busy, setBusy] = React40.useState(""),
          [error, setError] = React40.useState(""),
          [notice, setNotice] = React40.useState("");
        const [publishing, setPublishing] = React40.useState(null),
          [history2, setHistory] = React40.useState(null),
          [detail, setDetail] = React40.useState(null),
          [credentials, setCredentials] = React40.useState(null);
        ...
        async function versions(row) {
          ...
          try {
            const v = await request2(
              `${endpoint3}/versions?seriesId=${encodeURIComponent(row.seriesId)}`,
            );
        ...
        async function apply2(row, operation, secrets) {
          ...
          try {
            const path = project
              ? projectURL
              : `${endpoint3}/${operation === "install" ? "install" : "update"}`;
            ...
            if (e.message === "market_credentials_required" && !secrets) {
              try {
                const detail2 = await request2(
                  `${endpoint3}?id=${encodeURIComponent(row.id)}`,
                );
        ...
        async function updateAll() {
          ...
          try {
            ...
            if (project) {
              ...
              const v = await request2(`${endpoint3}/update`, {
                method: "POST",
        ...
        return h36(
          ...
          error
            ? h36("p", { role: "alert", className: "workagent-error" }, error)
            : null,
          notice ? h36("p", { role: "status" }, notice) : null,
          h36(Status2, { state: catalog }),
          ...rows.map((row) => {
            const current = currentFor(row);
            return h36(
              Card2,
              ...
              row.releaseNotes
                ...
                : null,
              row.skills?.length
                ? h36("p", null, `包含技能：${row.skills.join("、")}`)
                : null,
              row.mcp?.length
                ? h36("p", null, `包含 MCP：${row.mcp.join("、")}`)
                : null,
              action(row),
              row.kind === "mcp"
                ? h36(Button2, { onClick: () => setDetail(row) }, "详情")
                : null,
              h36(
                Button2,
          ...
          !catalog.loading && !rows.length
            ? h36("p", null, "暂无匹配内容，可以发布自己的能力。")
            : null,
          detail
            ? h36(MarketplaceDetail, {
          ...
          history2
            ? h36(
                ...
                h36("h3", null, `${history2.row.name} · 版本记录`),
                h36(
                  Button2,
          ...
          credentials
            ? h36(
                ...
                h36("h3", null, `配置 ${credentials.row.name}`),
                ...
                h36(Button2, { onClick: () => setCredentials(null) }, "取消"),
              )
            : null,
        );
      }
    ...
    var market = createMarketplace({
      ...
      h: import_react40.createElement,
      request,
      Section,
      Button,
      Card,
    ...
    function MarketplaceSection() {
      return (0, import_react40.createElement)(market.MarketplaceSection);
    }
    function MarketPublishForm({ onPublished, entry }) {
      const [kind, setKind] = import_react39.default.useState(
        entry?.kind || "skill",
      );
      const [sourceId, setSourceId] = import_react39.default.useState("");
      const [query, setQuery] = import_react39.default.useState("");
      const [error, setError] = import_react39.default.useState("");
      const [busy, setBusy] = import_react39.default.useState(false);
      const [skills] = useResource(`${apiRoot}/skills`);
      ...
      return (0, import_react40.createElement)(
        ...
        (0, import_react40.createElement)("h3", null, "发布到共享市场"),
        ...
        (0, import_react40.createElement)(
          Field,
          { label: "发布类型" },
          (0, import_react40.createElement)(Select, {
            value: kind,
            disabled: !!entry || busy,
            onChange: (e) => {
        ...
        (0, import_react40.createElement)(
          Field,
          { label: "搜索已安装内容" },
          (0, import_react40.createElement)(Input, {
            type: "search",
            value: query,
            onChange: (e) => setQuery(e.target.value),
          }),
        ...
        selected
          ? (0, import_react40.createElement)(
              ...
              (0, import_react40.createElement)(
                Field,
                { label: "说明" },
                (0, import_react40.createElement)("textarea", {
                  name: "description",
                  required: true,
                  maxLength: 4096,
    ...
    function CompletionNotificationSettings() {
      const routeSearch = navigation.useSearch();
      const endpoint3 = `${apiRoot}/completion-notifications`;
      const [state, refresh] = useResource(endpoint3);
      const saved = state.rows[0];
      const [draft, setDraft] = import_react41.default.useState(null);
      const [error, setError] = import_react41.default.useState("");
      const [saving, setSaving] = import_react41.default.useState(false);
      const [notice, setNotice] = import_react41.default.useState("");
      ...
      return (0, import_react42.createElement)(
        Section,
        { title: "消息提醒" },
        (0, import_react42.createElement)(workbench.Notifications),
        new URLSearchParams(routeSearch).get("session")
          ? (0, import_react42.createElement)(workbench.SessionReminder, {
        ...
        (0, import_react42.createElement)(Status, { state }),
        draft &&
          (0, import_react42.createElement)(
            "form",
            {
            ...
            (0, import_react42.createElement)(
              "label",
              { className: "workagent-inline" },
              (0, import_react42.createElement)(Switch, {
                "aria-label": "任务完成提醒",
            ...
            (0, import_react42.createElement)(
              "label",
              null,
              (0, import_react42.createElement)("input", {
                type: "checkbox",
        ...
        (0, import_react42.createElement)("h3", null, "最近推送"),
        (0, import_react42.createElement)(
          Button,
          { type: "button", onClick: refresh },
          "刷新推送记录",
        ...
        ...(saved?.deliveries || []).map((delivery) =>
          (0, import_react42.createElement)(
            ...
            (0, import_react42.createElement)("strong", null, delivery.title),
            (0, import_react42.createElement)(
              "p",
              null,
    ...
    function NotificationsPage() {
      const endpoint3 = "/api/portal/me/notifications";
      ...
      const open = async (row) => {
        try {
          if (!row.read_at)
            await request(`${endpoint3}/${encodeURIComponent(row.id)}/read`, {
              method: "POST",
            });
          await request(
            `${endpoint3}/${encodeURIComponent(row.id)}/acknowledge`,
            {
              method: "POST",
            },
          );
    ...
    function TopNotificationButton() {
      ...
      return (0, import_react42.createElement)(
        ...
        (0, import_react42.createElement)(Icon, {
          name: "notifications",
          size: 19,
        }),
        unread
    ...
    function NotificationFooter({ wide }) {
      ...
      return (0, import_react42.createElement)(
        ...
        (0, import_react42.createElement)(Icon, { name: "notifications" }),
        wide ? (0, import_react42.createElement)("span", null, "通知") : null,
        unread > 0
          ? (0, import_react42.createElement)(
              "span",
              { className: "workagent-badge" },
    ...
    function WorkspacesPage() {
      const endpoint3 = `${apiRoot}/workspaces`;
      const [state, refresh] = useResource(endpoint3);
      const [selectedId, setSelectedId] = import_react43.default.useState(null);
      const [error, setError] = import_react43.default.useState("");
      const [query, setQuery] = import_react43.default.useState("");
      const [creating2, setCreating] = import_react43.default.useState(false);
      const [showCreate, setShowCreate] =
        import_react43.default.useState(false);
      ...
      const createProject = async (event) => {
        ...
        setError("");
        try {
          const project = await request(endpoint3, {
            method: "POST",
      ...
      return (0, import_react44.createElement)(
        Section,
        { title: "项目" },
        (0, import_react44.createElement)(
          "div",
          { className: "workagent-project-intro" },
          (0, import_react44.createElement)(
            "div",
            null,
            (0, import_react44.createElement)("h2", null, "所有项目"),
            (0, import_react44.createElement)(
              "p",
              null,
              "文件与对话，在这里井然有序。",
        ...
        (0, import_react44.createElement)(
          ...
          (0, import_react44.createElement)(
            ...
            (0, import_react44.createElement)(Icon, {
              name: "search",
              size: 18,
            }),
            (0, import_react44.createElement)(Input, {
              "aria-label": "搜索项目",
              placeholder: "搜索项目名称…",
              value: query,
              onChange: (event) => setQuery(event.target.value),
          ...
          (0, import_react44.createElement)(
            ...
            (0, import_react44.createElement)(Icon, { name: "plus", size: 16 }),
            "新建项目",
          ),
        ),
        showCreate
        ...
        state.loading || state.error
          ? (0, import_react44.createElement)(Status, { state })
          : state.rows.length === 0
            ? (0, import_react44.createElement)(
                "div",
            ...
            (0, import_react44.createElement)(
              ...
              (0, import_react44.createElement)(
                Card,
                {
                  ...
                  title: (0, import_react44.createElement)(
                    "span",
                    null,
                    (0, import_react44.createElement)(Icon, {
                      name: "workspace",
              ...
              selectedId === workspace.id
                ? (0, import_react44.createElement)(
                    ...
                    (0, import_react44.createElement)(
                      ...
                      (0, import_react44.createElement)(FileIconButton, {
                        name: "close",
                        label: "收起项目文件",
                        onClick: () => setSelectedId(null),
                      }),
                    ),
                    (0, import_react44.createElement)(WorkspaceFileManager, {
                      key: workspace.id,
                      workspace,
    ...
    // src/features/system/feedback.js
    ...
    function FeedbackForm() {
      const [description, setDescription] = import_react45.default.useState("");
      const [steps, setSteps] = import_react45.default.useState("");
      const [files, setFiles] = import_react45.default.useState([]);
      const [notice, setNotice] = import_react45.default.useState("");
      const [busy, setBusy] = import_react45.default.useState(false);
      const [items, setItems] = import_react45.default.useState([]);
      const [diagnostic, setDiagnostic] = import_react45.default.useState("");
      const requestId = import_react45.default.useRef(operationId());
      const submitting = import_react45.default.useRef(false);
      ...
      const [previews, setPreviews] = import_react45.default.useState([]);
      import_react45.default.useEffect(() => {
      ...
      return (0, import_react45.createElement)(
        ...
        (0, import_react45.createElement)(
          ...
          (0, import_react45.createElement)(
            Field,
            { label: "问题描述" },
            (0, import_react45.createElement)("textarea", {
              required: true,
              maxLength: 2e3,
              value: description,
              disabled: busy,
          ...
          ...files.map((file, index) =>
            (0, import_react45.createElement)(
              ...
              { key: index },
              previews[index]
                ? (0, import_react45.createElement)("img", {
                    src: previews[index],
                    alt: file.name,
                    style: { maxWidth: "160px", maxHeight: "120px" },
                  })
                : null,
              (0, import_react45.createElement)("span", null, file.name),
              (0, import_react45.createElement)(
                Button,
                {
                  type: "button",
        ...
        ...items.map((item) =>
          (0, import_react45.createElement)(
            ...
            (0, import_react45.createElement)("p", null, item.description),
            (0, import_react45.createElement)("p", null, item.steps),
    ...
    function ChatPageSettings() {
      const [address, setAddress] = import_react46.default.useState(
      ...
      return (0, import_react47.createElement)(
        ...
        null,
        (0, import_react47.createElement)("h3", null, "聊天模式"),
        ...
        error
          ? (0, import_react47.createElement)("p", { role: "alert" }, error)
          : null,
        notice
          ? (0, import_react47.createElement)("p", { role: "status" }, notice)
          : null,
      );
    }
    function SystemSettings() {
      ...
      const [error, setError] = import_react46.default.useState("");
      const [notice, setNotice] = import_react46.default.useState("");
      const [busy, setBusy] = import_react46.default.useState(false);
      return (0, import_react47.createElement)(
        Section,
        { title: "系统与帮助" },
        confirmation,
        (0, import_react47.createElement)(ChatPageSettings),
        (0, import_react47.createElement)(
          "div",
          { className: "workagent-settings-heading" },
          (0, import_react47.createElement)("h3", null, "存储空间"),
          (0, import_react47.createElement)(
            Button,
            {
            ...
            (0, import_react47.createElement)(Icon, {
              name: "refresh",
              size: 16,
            }),
          ),
        ...
        (0, import_react47.createElement)(
          ...
          ...["personal", "shared"].map((kind) => {
            ...
            return (0, import_react47.createElement)(
              ...
              quota?.enabled
                ? (0, import_react47.createElement)("progress", {
        ...
        (0, import_react47.createElement)(
          "div",
          { className: "workagent-settings-heading" },
          (0, import_react47.createElement)("h3", null, "运行状态"),
          (0, import_react47.createElement)(
            Button,
            {
          ...
          ...(status.rows[0]?.components || []).map((row) =>
            (0, import_react47.createElement)(
              ...
              (0, import_react47.createElement)(
                ...
                (0, import_react47.createElement)("i", { "aria-hidden": true }),
                {
                  healthy: "正常",
                  unavailable: "暂不可用",
                  unhealthy: "异常",
        ...
        (0, import_react47.createElement)(FeedbackForm),
        (0, import_react47.createElement)(
          Button,
          {
            disabled: busy,
        ...
        notice
          ? (0, import_react47.createElement)("p", { role: "status" }, notice)
          : null,
        (0, import_react47.createElement)("h3", null, "使用帮助"),
        (0, import_react47.createElement)(
          "p",
          null,
    ...
    function TeamsPage() {
      const { confirm, confirmation } = useConfirm();
      const endpoint3 = `${apiRoot}/teams`;
      const [state, refresh] = useResource(endpoint3);
      const [presets] = usePresets();
      const [workspaces] = useResource(`${apiRoot}/workspaces`);
      const [sessions] = useResource(`${apiRoot}/sessions`);
      const [details, setDetails] = import_react48.default.useState({});
      const [selectedTeam, setSelectedTeam] =
        import_react48.default.useState(null);
      const [teamAction, setTeamAction] = import_react48.default.useState(null);
      const [teamActionValue, setTeamActionValue] =
        import_react48.default.useState("");
      const [operationId2, setOperationId] =
        import_react48.default.useState("");
      const [memberEngine, setMemberEngine] =
        import_react48.default.useState("codex");
      const [memberPresetId, setMemberPresetId] =
        import_react48.default.useState("");
      const [targetMemberId, setTargetMemberId] =
        import_react48.default.useState("");
      const [error, setError] = import_react48.default.useState("");
      import_react48.default.useEffect(() => {
        if (!selectedTeam || typeof EventSource === "undefined") return;
        const source = new EventSource(
          `${endpoint3}/${encodeURIComponent(selectedTeam.id)}/events`,
      ...
      const submit = async (event) => {
        event.preventDefault();
        const values = new FormData(event.currentTarget);
        await mutate(refresh, setError, endpoint3, "POST", {
          name: String(values.get("name")),
        ...
        try {
          const [tasks, messages, events, runs] = await Promise.all(
            ["tasks", "messages", "events", "runs"].map((name) =>
              request(`${endpoint3}/${encodeURIComponent(team.id)}/${name}`),
            ),
          );
          setDetails((value) => ({
            ...value,
      ...
      const submitTeamAction = async (event) => {
        ...
        const action = {
          run: {
            ...
            body: { input: value, operationId: operationId2 },
          },
          member: {
            suffix: "members",
            refresh,
        ...
        const saved = await mutate(
          action.refresh,
          setError,
          `${endpoint3}/${encodeURIComponent(team.id)}/${action.suffix}`,
          "POST",
          action.body,
        );
      ...
      const cancelTask = (team, taskEntry) =>
        mutate(
          () => loadDetails(team),
          setError,
          `${endpoint3}/${encodeURIComponent(team.id)}/tasks/${encodeURIComponent(taskEntry.id)}/cancel`,
          "POST",
        );
      return (0, import_react49.createElement)(
        ...
        (0, import_react49.createElement)(
          ...
          ...[
            ...
            (0, import_react49.createElement)(
              Field,
              { label, key: name },
              (0, import_react49.createElement)(Input, {
                name,
                required: true,
              }),
            ),
          ...
          (0, import_react49.createElement)(
            Field,
            { label: "团队项目" },
            (0, import_react49.createElement)(Select, {
              name: "workspaceId",
              required: true,
              defaultValue: "",
              options: [
        ...
        error
          ...
          : null,
        (0, import_react49.createElement)(Status, { state }),
                      ...
                      onSubmit: (event) => {
                        ...
                        if (name)
                          mutate(
                            refresh,
                            setError,
                            `${endpoint3}/${encodeURIComponent(team.id)}/members/${encodeURIComponent(member.id)}`,
                            "PATCH",
                            { name: name.trim() },
                          );
                      },
                        ...
                        Button,
                        {
                          onClick: () => {
                            ...
                            mutate(
                              refresh,
                              setError,
                              `${endpoint3}/${encodeURIComponent(team.id)}`,
                              "PATCH",
              ...
              ? (0, import_react49.createElement)(
                  ...
                  ...(details[team.id].runs || []).map((run) =>
                    (0, import_react49.createElement)(
                      ...
                      (0, import_react49.createElement)("p", null, run.input),
                      (0, import_react49.createElement)(
                        "p",
                        null,
                              ...
                              Button,
                              {
                                ...
                                onClick: () =>
                                  mutate(
                                    () => loadDetails(team),
                                    setError,
                                    `${endpoint3}/${encodeURIComponent(team.id)}/runs/${encodeURIComponent(run.id)}/${run.status === "running" ? "pause" : "resume"}`,
                                    "POST",
                                    {},
                                  ),
                              },
                              ...
                              Button,
                              {
                                ...
                                onClick: () =>
                                  mutate(
                                    () => loadDetails(team),
                                    setError,
                                    `${endpoint3}/${encodeURIComponent(team.id)}/runs/${encodeURIComponent(run.id)}/cancel`,
                                    "POST",
                                    {},
                                  ),
                              },
    ...
    function BrandMark({ size = 28 }) {
      return (0, import_react51.createElement)(
        ...
        (0, import_react51.createElement)(
          ...
          (0, import_react51.createElement)("path", {
    ...
    function WorkAgentOverlay() {
      const routeSearch = navigation.useSearch();
      const ctx = import_react50.default.useContext(RuntimeServices);
      ...
      const pageRef = import_react50.default.useRef(null);
      ...
      return (0, import_react51.createElement)(
        ...
        (0, import_react51.createElement)(
          ...
          (0, import_react51.createElement)("h1", null, label),
        ),
        (0, import_react51.createElement)(
          "main",
          { className: "workagent-overlay-content" },
          sessionId2
            ? (0, import_react51.createElement)(ConversationWorkspace, {
                key: sessionId2,
                sessionId: sessionId2,
              })
            : (0, import_react51.createElement)(Page, { key: target }),
        ),
      );
    }
    function FooterAction({ wide, kind, theme }) {
      if (kind === "notifications")
        return (0, import_react51.createElement)(NotificationFooter, { wide });
      const navigate = (page) => () =>
      ...
      return (0, import_react51.createElement)(
        ...
        (0, import_react51.createElement)(Icon, { name: kind }),
        wide ? (0, import_react51.createElement)("span", null, label) : null,
      );
    }
    ...
    function SidebarSessions() {
      ...
      const [batchMode, setBatchMode] = import_react52.default.useState(false);
      const [selectedIds, setSelectedIds] = import_react52.default.useState([]);
      const [batchBusy, setBatchBusy] = import_react52.default.useState(false);
      const [batchError, setBatchError] = import_react52.default.useState("");
      ...
      const [query, setQuery] = import_react52.default.useState("");
      const [searching, setSearching] = import_react52.default.useState(false);
      const [collapsed, setCollapsed] = import_react52.default.useState({});
      const [sectionsCollapsed, setSectionsCollapsed] =
        import_react52.default.useState(() => ({
          projects:
      ...
      const sectionToggle = (section, label) =>
        (0, import_react53.createElement)(
          ...
          (0, import_react53.createElement)(Icon, {
            name: sectionsCollapsed[section] ? "chevronRight" : "chevronDown",
            size: 13,
          }),
          (0, import_react53.createElement)("span", null, label),
        );
      const [action, setAction] = import_react52.default.useState(null);
      const [actionBusy, setActionBusy] =
        import_react52.default.useState(false);
      const [sessionMenu, setSessionMenu] =
        import_react52.default.useState(null);
      const [projectMenu, setProjectMenu] =
        import_react52.default.useState(null);
      const [reminderSession, setReminderSession] =
        import_react52.default.useState(null);
      const [actionValue, setActionValue] = import_react52.default.useState("");
      const [error, setError] = import_react52.default.useState("");
      ...
      const [, setSeenRevision] = import_react52.default.useState(0);
      const openedSession = import_react52.default.useRef(null);
          ...
          : unread
            ? session.lastTurn.status === "failed"
              ...
              : session.lastTurn.status === "cancelled"
                ...
                : "已完成，未读"
            : "";
        return (0, import_react53.createElement)(SidebarRow, {
          key: session.id,
          title: displaySessionTitle(session.title),
          icon: (0, import_react53.createElement)(SessionAvatar, { session }),
          selected: session.id === activeSession,
          status: (0, import_react53.createElement)(SidebarStatus, {
            running,
            unread,
            label: status,
          }),
          ...
          leading: batchMode
            ? (0, import_react53.createElement)("input", {
                type: "checkbox",
            ...
            : null,
          actions: (0, import_react53.createElement)(
            import_react52.default.Fragment,
            null,
            (0, import_react53.createElement)(SidebarAction, {
              icon: "pin",
      ...
      return (0, import_react53.createElement)(
        ...
        confirmation,
        (0, import_react53.createElement)(workbench.Notifications, {
          sessions: sessionState.rows,
          settings: false,
        }),
        (0, import_react53.createElement)("button", {
          type: "button",
          className: "workagent-mobile-backdrop",
          "aria-label": "收起导航菜单",
          tabIndex: -1,
        ...
        searching
          ? (0, import_react53.createElement)(SidebarSearch, {
              "aria-label": "搜索对话",
              value: query,
              onChange: (event) => setQuery(event.target.value),
              placeholder: "搜索对话…",
          ...
          ...(sectionsCollapsed.projects ? [] : projectRows).map((project) => {
            ...
            return (0, import_react53.createElement)(
              SidebarGroup,
              {
                ...
                icon: (0, import_react53.createElement)(Icon, {
                  name: "workspace",
                  size: 15,
                }),
                ...
                badge:
                  project.scope === "team"
                    ? (0, import_react53.createElement)("small", null, "共享")
                    : null,
                actions: (0, import_react53.createElement)(
                  import_react52.default.Fragment,
                  null,
        ...
        error && !action?.kind.endsWith("-session")
          ...
          : null,
        sessionMenu
          ? (0, import_react53.createElement)(ConversationMenu, {
          ...
          ? (0, import_react53.createElement)(
              ...
              (0, import_react53.createElement)(
                ...
                (0, import_react53.createElement)(
                  ...
                  (0, import_react53.createElement)(Icon, { name: "pin" }),
                ...
                (0, import_react53.createElement)(
                  ...
                  (0, import_react53.createElement)(Icon, { name: "edit" }),
                  "管理",
                ),
              ),
            )
        ...
        reminderSession
          ? (0, import_react53.createElement)(
              ...
              (0, import_react53.createElement)(workbench.SessionReminder, {
        ...
        action?.kind.endsWith("-session")
          ? (0, import_react53.createElement)(ConversationManagementDialog, {
              name: actionValue,
    ...
    function CollaborationSidebar(props) {
      ...
      const state = SharedPage.useShared();
      const tabs = import_react54.default.useSyncExternalStore(
      ...
      return (0, import_react55.createElement)(
        ...
        tab === "shared"
          ? (0, import_react55.createElement)(SharedPage.Sidebar)
          : extra
            ? extra.render({ ...props, sidebarUI })
            : (0, import_react55.createElement)(SidebarSessions, props),
      );
    }
    ...
    function useModelDefaults() {
      const raw = import_react56.default.useSyncExternalStore(
    ...
    function ModelDefaultsFields({ group, preset, defaults, save }) {
      ...
      const field = (label, props) =>
        (0, import_react57.createElement)(
          "label",
          null,
          (0, import_react57.createElement)("span", null, label),
          (0, import_react57.createElement)(Select, {
    ...
    function ModelsSection() {
      ...
      return (0, import_react58.createElement)(
        ...
        (0, import_react58.createElement)(Status, { state }),
        presets.loading || presets.error
          ? (0, import_react58.createElement)(Status, { state: presets })
          : null,
        ...groups.map(({ group, preset }) =>
          (0, import_react58.createElement)(
            ...
            (0, import_react58.createElement)(
              "header",
              null,
              (0, import_react58.createElement)(AssistantAvatar, {
            ...
            (0, import_react58.createElement)(ModelDefaultsFields, {
              group,
              preset,
            ...
            ...(preset ? [] : group.models).map((model) =>
              (0, import_react58.createElement)(
                ...
                (0, import_react58.createElement)(
                  "div",
                  null,
                  (0, import_react58.createElement)("strong", null, model.name),
                  model.id === resolveModelDefaults(group, preferences).modelId
                    ...
                    : null,
                  (0, import_react58.createElement)("small", null, model.id),
                ),
                (0, import_react58.createElement)(
                  "div",
    ...
    function TypographySettings() {
      const [size, setSize] = import_react59.default.useState(readFontSize);
      return (0, import_react60.createElement)(
        ...
        (0, import_react60.createElement)(
          "div",
          null,
          (0, import_react60.createElement)("strong", null, "字体大小"),
          (0, import_react60.createElement)(
            "p",
            null,
            "调整界面和对话文字，自动保存。",
    ...
    // src/features/apps/settings.js
    var import_react61 = __toESM(require("react"), 1);
    var import_react62 = require("react");
    var endpoint2 = "/api/portal/apps";
    var accessLabels = {
      owner: "仅自己",
      members: "指定成员",
    ...
    function expiryLabel(row) {
      const at =
        row.expiresAt && !row.expiresAt.startsWith("0001-")
          ? new Date(row.expiresAt)
          : null;
      if (!at) return "长期有效";
      if (at.getTime() <= Date.now())
        return `已于 ${at.toLocaleString("zh-CN")} 过期`;
    ...
    function PublishedAppsSection() {
      ...
      const [copied, setCopied] = import_react61.default.useState("");
      const { confirm, confirmation } = useConfirm();
      ...
      return (0, import_react62.createElement)(
        ...
        error
          ...
          : null,
        (0, import_react62.createElement)(Status, { state }),
        ...state.rows.map((row) =>
          (0, import_react62.createElement)(
            Card,
            {
              ...
              Button,
              {
                onClick: () =>
                  mutate(
                    refresh,
                    setError,
                    `${endpoint2}/${encodeURIComponent(row.id)}/${row.enabled ? "unpublish" : "enable"}`,
                    "POST",
                  ),
              },
              row.enabled ? "停用" : "启用",
                ...
                onClick: async () => {
                  ...
                  if (ok)
                    await mutate(
                      refresh,
                      setError,
                      `${endpoint2}/${encodeURIComponent(row.id)}/delete`,
                      "POST",
                    );
                },
              },
    ...
    function createImports({
      ...
      function SkillImport({ onImported }) {
        const [format, setFormat] = React40.useState("directory");
        const [busy, setBusy] = React40.useState(false);
        const [error, setError] = React40.useState("");
        const [result, setResult] = React40.useState([]);
        ...
        return h36(
          ...
          h36(
            ...
            h36(
              Field2,
              { label: "导入技能名称" },
              h36(Input2, { name: "name", required: true, maxLength: 120 }),
            ),
            h36(
              Field2,
              { label: "技能描述" },
              h36(Input2, { name: "description", maxLength: 4e3 }),
            ),
            h36(
              Field2,
              { label: "技能来源" },
              h36(
                ...
                h36("option", { value: "directory" }, "本地目录"),
                h36("option", { value: "zip" }, "ZIP 包"),
              ),
            ),
            h36(
              Field2,
            ...
            error ? h36("p", { role: "alert" }, error) : null,
            h36(Results, { rows: result }),
          ),
        );
      }
      function MCPImport({ onImported }) {
        const [text, setText] = React40.useState("");
        const [busy, setBusy] = React40.useState(false);
        const [rows, setRows] = React40.useState([]);
        const [error, setError] = React40.useState("");
        async function submit(e) {
        ...
        return h36(
          "details",
          null,
          h36("summary", null, "批量导入 MCP JSON"),
          h36(
            "form",
            { className: "workagent-form", onSubmit: submit },
            h36(
      ...
      function History() {
        ...
        return h36(
          ...
          null,
          h36("h3", null, "能力导入记录"),
          h36(Button2, { onClick: refresh }, "刷新导入记录"),
          state.error
            ? h36("p", { role: "alert" }, friendlyError2(state.error))
            : null,
          ...state.rows
            .slice()
            .reverse()
    ...
    function CapabilitySync({ kind, onSynced }) {
      ...
      const [busy, setBusy] = import_react63.default.useState(false);
      const [error, setError] = import_react63.default.useState("");
      const sync = async () => {
        setBusy(true);
        setError("");
        try {
      ...
      return (0, import_react64.createElement)(
        ...
        error
          ? (0, import_react64.createElement)("p", { role: "alert" }, error)
          : null,
        ...problems.map((row) =>
          (0, import_react64.createElement)(
            "p",
    ...
    function MCPBody() {
      const endpoint3 = `${apiRoot}/mcp-servers`;
      const [state, refresh] = useResource(endpoint3);
      const [error, setError] = import_react63.default.useState("");
      const [transport, setTransport] = import_react63.default.useState("http");
      const submit = async (event) => {
        event.preventDefault();
        const form = event.currentTarget;
        const values = new FormData(form);
        ...
        await mutate(refresh, setError, endpoint3, "POST", body);
        form.reset();
      };
      const oauth = async (row) => {
        try {
          const value = await request(
            `${endpoint3}/${encodeURIComponent(row.id)}/oauth/start`,
            {
              method: "POST",
              body: JSON.stringify({
      ...
      return (0, import_react64.createElement)(
        ...
        null,
        (0, import_react64.createElement)(CapabilitySync, {
          kind: "mcp",
          onSynced: refresh,
        }),
        (0, import_react64.createElement)(imports.MCPImport, {
          onImported: refresh,
        }),
        (0, import_react64.createElement)(
          "form",
          ...
          (0, import_react64.createElement)(
            Field,
            { label: "名称" },
            (0, import_react64.createElement)(Input, {
              name: "name",
              required: true,
            }),
          ),
          (0, import_react64.createElement)(
            Field,
            { label: "连接方式" },
            (0, import_react64.createElement)(Select, {
              value: transport,
        ...
        error
          ...
          : null,
        (0, import_react64.createElement)(Status, { state }),
        ...state.rows.map((row) =>
          (0, import_react64.createElement)(
            Card,
            {
              ...
              Button,
              {
                onClick: () =>
                  mutate(
                    refresh,
                    setError,
                    `${endpoint3}/${encodeURIComponent(row.id)}/test`,
                    "POST",
                  ),
              },
              "测试连接",
    ...
    function SkillsBody() {
      const endpoint3 = apiRoot + "/skills";
      const [state, refresh] = useResource(endpoint3);
      const [error, setError] = import_react63.default.useState("");
      return (0, import_react64.createElement)(
        import_react63.default.Fragment,
        ...
        (0, import_react64.createElement)(imports.SkillImport, {
          onImported: refresh,
        }),
        (0, import_react64.createElement)(
          "p",
    ...
    function MCPSkillsSection() {
      return (0, import_react64.createElement)(
        ...
        (0, import_react64.createElement)(
          "h3",
          { className: "workagent-subheading" },
          "MCP 服务",
        ),
        (0, import_react64.createElement)(MCPBody),
        (0, import_react64.createElement)(
          "h3",
          { className: "workagent-subheading" },
          "技能",
        ),
        (0, import_react64.createElement)(SkillsBody),
      );
    }
    ...
    function useDraftOption(key, options, defaultId, revision) {
      const [selection, setSelection] = import_react65.default.useState({
        revision,
        values: {},
      });
      const saved =
    ...
    function HeroWorkspaceComposer() {
      ...
      return projectId
        ? (0, import_react66.createElement)(SharedTaskComposer, {
            key: projectId,
            projectId,
          })
        : (0, import_react66.createElement)(WorkspaceComposer);
    }
    function SharedTaskComposer({ projectId }) {
      ...
      return (0, import_react66.createElement)(WorkspaceComposer, {
    ...
    function WorkspaceComposer({ sharedProject } = {}) {
      ...
      const [personalProjectChoice, setProjectChoice] =
        import_react65.default.useState(
          () =>
      ...
      const [presetId, setPresetId] = import_react65.default.useState(
        () => localStorage.getItem(AGENT_PICK_KEY) || "builtin-general",
      );
      const [projectName, setProjectName] = import_react65.default.useState("");
      const [preferences, , defaultsRevision] = useModelDefaults();
      const [message, setMessage] = workbench.useDraft(`home:${projectChoice}`);
      const [attachmentsBusy, setAttachmentsBusy] =
        import_react65.default.useState(false);
      const [busy, setBusy] = import_react65.default.useState(false);
      const [error, setError] = import_react65.default.useState("");
      import_react65.default.useEffect(() => {
        window.dispatchEvent(
      ...
      return (0, import_react66.createElement)(
        ...
        (0, import_react66.createElement)(
          ...
          (0, import_react66.createElement)(workbench.ComposerTools, {
            key: projectChoice,
            session: {
              id: "home",
              workspaceId:
          ...
          (0, import_react66.createElement)(ComposerInput, {
            "aria-label": "输入消息",
          ...
          (0, import_react66.createElement)(
            ...
            (0, import_react66.createElement)(
              ...
              (0, import_react66.createElement)(
                ...
                (0, import_react66.createElement)(Select, {
                  "aria-label": "模型",
                  value: modelId,
            ...
            (0, import_react66.createElement)(
              ...
              (0, import_react66.createElement)(Icon, {
                name: "send",
                size: 18,
              }),
            ),
        ...
        (0, import_react66.createElement)(
          ...
          projectChoice === "new"
            ? (0, import_react66.createElement)(
                ...
                (0, import_react66.createElement)(Input, {
    ...
    function FileSidebarPanel({
      ...
      const [open, setOpen] = import_react67.default.useState(
        () =>
          localStorage.getItem("workagent.files.open") === "true" ||
          (localStorage.getItem("workagent.files.open") === null &&
            window.innerWidth >= 1100),
      );
      const [width, setWidth] = import_react67.default.useState(
      ...
      return (0, import_react68.createElement)(
        import_react67.default.Fragment,
        null,
        (0, import_react68.createElement)(
          "div",
          { className: "workagent-top-actions" },
          (0, import_react68.createElement)(TopNotificationButton),
          (0, import_react68.createElement)(
            "button",
            {
              type: "button",
            ...
            (0, import_react68.createElement)(Icon, {
              name: "workspace",
              size: 19,
            }),
          ),
        ...
        open
          ? (0, import_react68.createElement)("button", {
              type: "button",
        ...
        (0, import_react68.createElement)(
          ...
          (0, import_react68.createElement)(ResizeHandle, {
            orientation: "vertical",
            value: width,
          ...
          (0, import_react68.createElement)(
            "header",
            { className: "workagent-files-panel-header" },
            (0, import_react68.createElement)("strong", null, "项目文件"),
            (0, import_react68.createElement)(FileIconButton, {
              name: "expand",
          ...
          state.error || sessionError
            ...
            : state.loading || sessionLoading
              ...
              : workspace
                ? (0, import_react68.createElement)(WorkspaceFileManager, {
                    key: workspace.id,
                    workspace,
                    ...sharedFiles,
    ...
    function HomeFileSidebar() {
      const routeSearch = navigation.useSearch();
      const [workspaceId, setWorkspaceId] = import_react67.default.useState(
        () =>
          new URLSearchParams(routeSearch).get("project") ||
          localStorage.getItem(WORKSPACE_PICK_KEY) ||
          "",
      ...
      return (0, import_react68.createElement)(FileSidebarPanel, {
        workspaceId,
        onProjectChange: (id) => {
          setWorkspaceId(id);
    ...
    function FileSidebar() {
      ...
      return sessionId2
        ? (0, import_react68.createElement)(SessionFileSidebar, {
            key: sessionId2,
            sessionId: sessionId2,
          })
        : (0, import_react68.createElement)(HomeFileSidebar);
    }
    ...
    function QuotaPanel() {
      ...
      const meter = (label, used, limit) => {
        ...
        return (0, import_react70.createElement)(
          "div",
          { className: "workagent-quota-row" },
          (0, import_react70.createElement)("span", null, label),
          (0, import_react70.createElement)("span", null, value),
          (0, import_react70.createElement)(
            "div",
            {
            ...
            (0, import_react70.createElement)("span", {
              style: { width: value },
            }),
          ),
        );
      ...
      return (0, import_react70.createElement)(
        ...
        (0, import_react70.createElement)("strong", null, "剩余额度"),
        (0, import_react70.createElement)(Status, { state }),
        ...state.rows.map((b) =>
          (0, import_react70.createElement)(
            "div",
    ...
    function apply(ctx) {
      ...
      for (const [order, kind] of [
        ...
        ctx.slots.inject("sidebar.footer.action", () =>
          ctx.slots.register(
            ...
            (props) =>
              (0, import_react71.createElement)(FooterAction, {
                ...props,
                kind,
                theme: ctx.theme,
              }),
      ...
      ctx.slots.inject("shell.overlay", () =>
        ctx.slots.register(
          ...
          (props) =>
            (0, import_react71.createElement)(
              RuntimeServices.Provider,
              { value: ctx },
              (0, import_react71.createElement)(WorkAgentOverlay, props),
            ),
        ),
      );
      ctx.slots.inject("shell.overlay", () =>
